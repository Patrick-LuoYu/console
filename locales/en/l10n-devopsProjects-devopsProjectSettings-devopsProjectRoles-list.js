...
module.exports = {
  ...
  MODULES: 'Modules',
  // Create > Edit Permissions > Pipeline Management
  ...
  // Create > Edit Permissions > Credential Management
  ...
  // Create > Edit Permissions > Access Control

  ROLES_MANAGEMENT: 'Role Management',
  ROLES_VIEW: 'Role Viewing',
  // Create > Edit Permissions > DevOps Settings
