...
module.exports = {
  ...
  // Container Logs > Details Page > Edit
  INDEX_PREFIX: 'Index Prefix',
  // Container Logs > Details Page > More
  CHANGE_STATUS: 'Change Status',
  // Container Logs > Details Page > More > Change Status
  LOG_COLLECTION_ENABLE_TIPS:
    'The new status requires about 1 minute to take effect.',
  SELECT_STATUS_TIP: 'Select a status',
  // Container Logs > Details Page > Resource Status
  ADDRESS: 'Address',
  // Resource Events
  // Audit Logs
}
