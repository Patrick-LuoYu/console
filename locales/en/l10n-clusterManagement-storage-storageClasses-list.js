...
module.exports = {
  ...
  CUSTOM: 'Custom',
  // Create > > QingCloud CSI > Storage Class Settings
  ...
  // Create > > GlusterFS > Storage Class Settings
  ...
  GID_MIN: 'Minimum GID',
  GID_MAX: 'Maximum GID',
  // Create > > Ceph RBD > Storage Class Settings
  ...
  // Create > > Custom > Storage Class Settings
