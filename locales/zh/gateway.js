...
module.exports = {
  ...
  CLUSTER_GATEWAYS_SETTING_DESC: '创建应用路由之前，需要先启用外网访问入口，即网关。这一步是创建对应的应用路由控制器，负责将请求转发到对应的后端服务。',
  PROJECT_GATEWAYS_SETTING_DESC: '集群管理页面不支持项目网关的设置，如需设置需要转到对应项目下进行设置。',
  ...
  CLUSTER_GATEWAY_GUIDE_DESC: '开启集群网关后，无法再设置项目网关。若已存在项目网关，删除后无法重新设置。',
  'Request Count': '请求量',
