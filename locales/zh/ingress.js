...
module.exports = {
  ...
  NO_GATEWAY_DESC: '如需使用自动生成模式，请联系项目管理员在此项目的高级设置中设置网关访问方式。',
  ...
  UNABLE_TO_ACCESS_TIP: '● 请确保您设置的域名可以解析到访问入口的 IP 地址;<br/>● 如果在私有云环境中，请修改本地的 host 文件，并通过&lt域名&gt:&ltNodePort&gt的方式来访问;<br/>● 通过通配 DNS 访问，将域名修改为&ltHostname&gt.&lt网关地址&gt.nip.io，然后可以通过&ltHostname&gt.&lt网关地址&gt.nip.io:&ltNodePort&gt的形式来访问服务;<br/>● 如果通过域名访问被拦截，请确认您的域名是真实域名而且已经备案。',
  ...
  ACCESS_TYPES_OF_ROUTE_A: 'KubeSphere 应用路由支持 NodePort 访问方式以及 LoadBalancer 访问方式。',
  // Route Detail Page
