...
module.exports = {
  ...
  HOW_PUBLISH_APP_DESC: '您可以将 Helm chart 上传为企业空间的应用模板，提交审核后，可以将应用发布在应用商店中。',
  ...
  APP_REVIEW_DESC: 'KubeSphere 支持对待上架应用进行内容审核，您可以查看审核内容并批准或拒绝应用上架。',
  ...
  APP_CATEGORIES_DESC: '您可以在此页面创建、编辑、删除分类，对已上架的应用进行分类管理。',
  ...
  APP_CREATE_GUIDE: '请参阅开发指南 <a href={url} target="_blank" rel="noreferrer noopener">Helm 规范</a>。',
