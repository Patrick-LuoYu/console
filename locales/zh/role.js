...
module.exports = {
  ...
  WORKSPACE_ROLES_MANAGEMENT_DESC: '创建、编辑和删除系统预置角色外的企业空间角色。',
  ...
  WORKSPACE_APP_TEMPLATES_MANAGEMENT_DESC: '上传、编辑和删除应用模板以及在平台应用商店上架和下架应用。',
  ...
  WORKSPACE_SETTINGS_MANAGEMENT_DESC: '管理企业空间的基本信息、网络策略等设置。',
  ROLE_PLATFORM_ADMIN: '平台管理员，可以管理 KubeSphere 平台上的所有资源。',
  ROLE_PLATFORM_REGULAR: '平台普通用户，在被邀请加入企业空间之前没有任何资源操作权限。',
  ...
  ROLE_WORKSPACES_MANAGER: '平台企业空间管理员，可以管理 KubeSphere 平台上的所有企业空间。',
  ...
  ROLE_WORKSPACE_SELF_PROVISIONER: '企业空间普通成员，可以查看企业设置、管理应用模板、创建项目和 DevOps 工程。',
  ROLE_PROJECT_ADMIN: '项目管理员，可以管理项目中的所有资源。',
  ROLE_PROJECT_REGULAR: 'Project regular user who can manage resources other than users and roles in the project.',
  ...
  ROLE_DEVOPS_REGULAR: 'DevOps project operator who can manage pipelines and credentials and view members and roles in the DevOps project.',
  ROLE_DEVOPS_VIEWER: 'DevOps 工程观察员，可以查看 DevOps 工程中的所有资源。',
  ROLE_DEVOPS_OPERATOR: 'DevOps 工程操作员，可以管理 DevOps 凭证和流水线以及查看 DevOps 工程中成员和角色。',
